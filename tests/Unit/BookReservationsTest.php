...
class BookReservationsTest extends TestCase
{
    ...
    // if book is not checked out, throw exeception
    /** @test */
    ...
    public function a_user_can_checkout_a_book_twice()
    {
        ...
        $this->assertEquals(today(), Reservation::find(2)->checked_out_at);
        ...
        $this->assertEquals(today(), Reservation::find(2)->checked_in_at);
